...
import { BackendSystemPulse } from "./backend-system-pulse";
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-8">
          ...
          <BackendSystemPulse lang={lang} variant="full" className="hidden shrink-0 lg:block" />
        </div>

        <BackendSystemPulse lang={lang} variant="compact" className="mt-10 lg:hidden" />
      </div>
    </section>
  );
}
